...
# ./manage.py dumpscript large_dms
...
def run():
    ...
    document_1.date_added = datetime.datetime(2009, 1, 26, 1, 39, 9)
    document_1.date_updated = datetime.datetime(2009, 1, 26, 1, 48, 9)
    document_1.document_id = u'TTH9R'
    ...
    document_1.author = u'Curabitur Urna'
    document_1.date_created = datetime.datetime(2008, 12, 26, 1, 40, 15)
    document_1.plaintext = u''
    document_1.uploaded_by = None
    document_1.save()
    ...
    document_2.date_added = datetime.datetime(2009, 1, 26, 1, 40, 10)
    document_2.date_updated = datetime.datetime(2009, 1, 26, 1, 48, 5)
    document_2.document_id = u'45FLU'
    ...
    document_2.author = u'Integer Sapien'
    document_2.date_created = datetime.datetime(2008, 4, 26, 12, 39, 55)
    document_2.plaintext = u''
    document_2.uploaded_by = None
    document_2.save()
    ...
    document_3.date_added = datetime.datetime(2009, 1, 26, 1, 41, 2)
    document_3.date_updated = datetime.datetime(2009, 1, 26, 1, 48)
    document_3.document_id = u'6ACXD'
    ...
    document_3.author = u'Aenean Pretium'
    document_3.date_created = datetime.datetime(2009, 1, 26, 1, 41)
    document_3.plaintext = u''
    document_3.uploaded_by = None
    document_3.save()
    ...
    document_4.date_added = datetime.datetime(2009, 1, 26, 1, 45, 28)
    document_4.date_updated = datetime.datetime(2009, 1, 26, 1, 47, 54)
    document_4.document_id = u'8G98W'
    ...
    document_4.author = u'Aenean Diam'
    document_4.date_created = datetime.datetime(2009, 1, 10, 11, 45, 18)
    document_4.plaintext = u''
    document_4.uploaded_by = None
    document_4.save()
    ...
    document_5.date_added = datetime.datetime(2009, 1, 26, 1, 46, 31)
    document_5.date_updated = datetime.datetime(2009, 1, 26, 1, 47, 48)
    document_5.document_id = u'AQ6HF'
    ...
    document_5.author = u'Curabitur Urna'
    document_5.date_created = datetime.datetime(2008, 7, 20, 15, 46, 20)
    document_5.plaintext = u''
    document_5.uploaded_by = None
    document_5.save()
    ...
    document_6.date_added = datetime.datetime(2009, 1, 26, 1, 47, 42)
    document_6.date_updated = datetime.datetime(2009, 1, 26, 1, 47, 42)
    document_6.document_id = u'DV3TY'
    ...
    document_6.author = u'Sed Porttitor'
    document_6.date_created = datetime.datetime(2008, 4, 3, 18, 47, 28)
    document_6.plaintext = u''
    document_6.uploaded_by = None
    document_6.save()

    from django_dms.apps.large_dms.models import Tag

    tag_1 = Tag()
    tag_1.name = u'Featured'
    tag_1.save()

    tag_2 = Tag()
    tag_2.name = u'Important'
    tag_2.save()

    tag_1.documents.add(document_1)
    tag_1.documents.add(document_2)
    tag_1.documents.add(document_3)
    tag_1.documents.add(document_4)

    tag_2.documents.add(document_3)
    tag_2.documents.add(document_4)
    tag_2.documents.add(document_6)
